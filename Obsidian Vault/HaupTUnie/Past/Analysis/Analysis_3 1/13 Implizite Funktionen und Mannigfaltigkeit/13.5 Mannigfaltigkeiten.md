...
Dabei heißt $\varphi : U_{\varphi} \rightarrow D_{\varphi}$ ==Karte der Menge $M$==, wenn $U_{\varphi}, D_{\varphi} \subseteq \mathbb{R}^p$ offen sind, wenn $\varphi$ ein $C^1$- Differmorphismus [[HaupTUnie/Past/Analysis/Analysis_3 1/13 Implizite Funktionen und Mannigfaltigkeit/13.3 Der Umkehrsatz#Definition 13.3.4]] ist und wenn
$$
...
$$
Man überzeugt sich leicht, dass $dT(x)$ für alle $x \in D_{\varphi}$ regulär und $T$ injektiv ist. Gemäß [[HaupTUnie/Past/Analysis/Analysis_3 1/13 Implizite Funktionen und Mannigfaltigkeit/13.3 Der Umkehrsatz#Korollar 13.3.3]] ist dann $U_{\varphi} := T(D_{\varphi})$ offen und $\varphi := T^{-1} : U_{\varphi} \rightarrow D_{\varphi}$ ein Diffeomorphismus. Also ist $M := T((-1, 1) \times (-1, 1) \times \{0\})$ eine Fläche und daher eine 2-dimensionale Mannigfaltigkeit im $\mathbb{R}^3$.
