## Vorlesung 24.3.25
  $$y' = A y,\quad A \in \mathbb{R}^{n \times n}\tag{3.7}$$
- **Fundamentalmatrix:**   $$e^{tA} = \sum_{n=0}^{\infty} \frac{1}{n!} (tA)^n$$
- **Lösung von** $y' = A y,\quad y(t_0) = y_0$  $$y(t) = e^{(t - t_0) A} y_0$$

---

### 3.2.1 Berechnung von $e^{tA}$

$e^{tA}$ wird typischerweise durch **Diagonalisieren** bestimmt.  Sei $A = V D V^{-1}$ Dann:
$$
\begin{aligned}
...
$\Leftrightarrow \tilde{y}_i(t) = e^{d_i t} \tilde{y}_{0,i}, 1 = 1, \dots, d$
$$
